...
@section('content')
    ...
    <div class="card shadow" style="max-height: 80vh;">
        <div class=" card-header py-3 ">
            <p class="text-primary m-0 font-weight-bold ">Nouvelle Charge</p>
        </div>
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="input-group my-3">
                                    ...
                                    <input type="text" required id="nom" class="dossier-input" name="nom"
                                        placeholder="Nom">
                                </div>
                            </div>
                            <div class="col-3">
                                <div class="input-group my-3">
                                    ...
                                    <input type="number" required id="cout" class="dossier-input" value="0" name="cout"
                                        placeholder="Coût">
                                </div>
                            </div>
                            <div class="col-3">
                                <div class="input-group my-3">
                                    ...
                                    <input type="number" required id="mois" class="dossier-input" value="0" name="mois"
                                        placeholder="Mois">
                                </div>
                            </div>
                        </div>
