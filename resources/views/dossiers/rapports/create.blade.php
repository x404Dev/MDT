                ...
                <div class="col-7">
                    <form action="{{ route('dossiers.rapports.store', $dossier->id) }}" method="POST">
                        ...
                        <div class="input-group my-3">
                            ...
                            <input type="text" required id="titre" class="dossier-input" name="titre" placeholder="Titre">
                        </div>
                        <div class="input-group my-3">
                            <label for="notes" class="mr-4">Informations: </label>
                            <textarea id="notes" class="dossier-input" name="notes" placeholder="Informations"></textarea>
                        </div>
                    </form>
                </div>
